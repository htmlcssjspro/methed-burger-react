...
export default function Footer() {
    return (
        <footer className={classNames(container, style.footer)}>
            <Content className={style.content}>
                <Wrapper className={style.logo}>
                    <svg
                        role="img"
                ...
                <div className={style.contact}>
                    <p className={style.subtitle}>Номер для заказа</p>
                    <a className={style['link-phone']} href="tel:+79308333811">
                        <svg width="24"
                            height="24"
                            viewBox="0 0 24 24"
                            fill="currentColor"
                ...
                <div className={style.contact}>
                    <p className={style.subtitle}>Мы в соцсетях</p>
                    <ul className={style.list}>
                        <li className={style['list-item']}>
                            <a className={style['link-sn']}
                                href="https://vk.com"
                                aria-label="ссылка на нашу группу в вконтакте">
                                <svg width="36"
                                    height="36"
                                    viewBox="0 0 36 36"
                                    fill="currentColor"
                        ...
                        <li className={style['list-item']}>
                            <a className="footer__link-sn"
                                href="https://tg.com"
                                aria-label="ссылка на наш канал в телеграм" >
                                <svg width="36"
                                    height="36"
                                    viewBox="0 0 36 36"
                                    fill="currentColor"
